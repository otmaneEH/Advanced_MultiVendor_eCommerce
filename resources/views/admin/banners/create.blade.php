                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="title" class="form-control" id="validationServer01"
                                        placeholder="Banner title..." value="{{ old('title') }}" required>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-outline">
                                        <textarea value="{{ old('desc') }}" name="desc" class="form-control" id="textAreaExample3" rows="2"></textarea>
                                    </div>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="condition" class="form-control">
                                        <option value="bannner" {{ old('condition') == 'bannner' ? 'selected' : '' }}>Banner</option>
